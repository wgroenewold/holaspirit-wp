(function ($) {
   ...
   $(document).on('click', 'div[data-name="hs_generate_token"] input[type="radio"]', function(){
      $.ajax({
         url : ajax.ajaxurl,
         type : 'post',
         data : {
   ...
   $(document).on('click', 'div[data-name="hs_fetch_users"] input[type="radio"]', function(){
      fetch_data('users');
   });

   $(document).on('click', 'div[data-name="hs_fetch_roles"] input[type="radio"]', function(){
      fetch_data('roles');
   });
